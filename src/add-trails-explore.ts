                    ...
                    if (container) {
                        ...
                        if (stats) {
                            container.innerHTML = `
                                ...
                                <h4>${trail.name}<span id="grade-mark" class='${trail.grade}'>
                                ...
                                <a href="/trails/${trail.name}.gpx" download="${trail.name}.gpx" class="download-link"><i class="fa-solid fa-download"></i></a>
                            `;
